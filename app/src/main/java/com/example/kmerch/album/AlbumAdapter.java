...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ViewHolder> {
    ...
    ArrayList<AlbumModel> kmerchModels = new ArrayList<>();
    ...
    public ArrayList<AlbumModel> getKmerchModels() {
        return kmerchModels;
    }

    public void setKmerchModels(ArrayList<AlbumModel> kmerchModels) {
